...
<li><b>REST API 사양서</b>는, gitbook으로 발행됩니다. <a href="https://baes-organization.gitbook.io/board_maker/reference/board_maker-api">이 링크</a>에서 확인 가능합니다.</li>
...
현재(230414), Front-end와 Back-end 제조 중입니다. 현황은 commit을 확인해주십시오.
